...
?>
    <div class="container">
        ...
        <div class="card-body">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div>
                                <h5 class="modal-title" id="exampleModalLabel">نام نویسی بیمار</h5>
            ...
            <button   href="#" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#eampleModal">
                ثبت نام پذشک
            </button>
            <!-- Modal -->
            <div class="modal fade" id="eampleModal" tabindex="-1" aria-labelledby="xampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div>
                                <h5 class="modal-title" id="xampleModalLabel"> نام نویسی پذشک</h5>
                                <p class="text-secondary">سریع و ایمن</p>
                            </div>
                        </div>
                        <div class="modal-body">
