...
if($flag == 1)
{
    ...
    if(isset($bio))
    {
        $db->query("INSERT INTO `users`(`id`, `name`, `family`, `username`, `password`, `email`, `mobile`) VALUES ('$first_name', '$last_name', '$user_name', '$hash_password', '$email', '$mobile_number' )");
    }
    else
    {
        $db->query("INSERT INTO `users`(`id`, `name`, `family`, `username`, `password`, `email`, `mobile`) VALUES ('$first_name', '$last_name', '$user_name', '$hash_password', '$email', '$mobile_number', $gender,)");
